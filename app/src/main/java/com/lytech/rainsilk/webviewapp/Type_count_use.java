 ...
 */
public class Type_count_use extends Activity {
        ...
        mFocusChangedListener = new View.OnFocusChangeListener() {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                if (hasFocus) {
                    ...
                    IBinder mIBinder = Type_count_use.this.getCurrentFocus().getWindowToken();
...
//            //Self ID
            ...
            if (authenticate) {
                ...
                memberCount = serverRequests.doInBackground(contact, memberID, new GetUserCallback() {
                    ...
                    public void done(Contact returnedContact) {
                        ...
                        //扣客人折扣點數 使用在店家
                        memberGiftCount = Integer.toString((int) (Integer.parseInt(memberGiftCount) - (Integer.parseInt(servicecount))));
                        //res1 = Integer.toString((int)((Integer.parseInt(memberGiftCount) + (Integer.parseInt(servicecount)) * 0.5) + 0.5));

                        //TODO:點數不可為負!

                        AlertDialog.Builder ab = new AlertDialog.Builder(Type_count_use.this);

                        ab.setTitle("與本店之交易確認")
                                .setMessage("確認出貨並扣除客人折扣點數" + servicecount + "點,是否同意?")
                                .setCancelable(true);
                        ...
                        ab.setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                //寫入店家自己
                                new SetCount(contact.id, mycount, mygiftcount).execute();
                                //寫入客人
                                new SetCount(memberID, memberCount, memberGiftCount).execute();
                                Count count;
                                Date mDate = new Date();
                                ...
                                //店家小額扣除
                                count = new Count("6", contact.id, memberID, "mycount", memberCount, "mygiftcount", res1, time);

                                Context mCtx;
                                mCtx = Type_count_use.this;
    ...
    private class SetCount extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            Toast.makeText(getApplicationContext(), "現金點數扣除成功!", Toast.LENGTH_SHORT).show();
        }
    }
}
