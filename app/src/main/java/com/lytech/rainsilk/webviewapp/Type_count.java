 ...
 */
public class Type_count extends Activity {
        ...
        mFocusChangedListener = new View.OnFocusChangeListener() {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                if (hasFocus) {
                    ...
                    IBinder mIBinder = Type_count.this.getCurrentFocus().getWindowToken();
            ...
            if (authenticate) {
                ...
                memberCount = serverRequests.doInBackground(contact, memberID, new GetUserCallback() {
                    ...
                    public void done(Contact returnedContact) {
                        ...
                        //加客人 giftcount 路程*0.1
                        res1 = Integer.toString(Integer.parseInt(memberGiftCount) + (int) ((Integer.parseInt(servicecount)) * 0.1 + 0.5));
