...
public class MapsShowGuestActivity extends FragmentActivity implements ConnectionCallbacks,
    ...
    Thread thread;
    //TODO:動態配置人數
    double[] guestlat = new double[6];
    double[] guestlng = new double[6];
    String temp1, temp2;
    Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            markerOptthread.title("會員" + msg.what + "號");
    ...
    protected void onPause() {
        ...
        // ������m�ШD�A��
        if (googleApiClient.isConnected()) {
            LocationServices.FusedLocationApi.removeLocationUpdates(googleApiClient, MapsShowGuestActivity.this);
        }
    }
        ...
        mMap.setOnInfoWindowClickListener(new GoogleMap.OnInfoWindowClickListener() {
            ...
            public void onInfoWindowClick(Marker marker) {
                ...
                if (marker.equals(itemMarker)) {
                    AlertDialog.Builder ab = new AlertDialog.Builder(MapsShowGuestActivity.this);
...
//
    ...
    public void onConnected(Bundle bundle) {
        ...
        LocationServices.FusedLocationApi.requestLocationUpdates(googleApiClient, locationRequest, MapsShowGuestActivity.this);
    }
    ...
    private void Showguestinfo() {
        ...
        try {
            String result = DBConnector.executeQueryGuest(area);
            Log.e("rainsilk", "guest locate result=" + result);
