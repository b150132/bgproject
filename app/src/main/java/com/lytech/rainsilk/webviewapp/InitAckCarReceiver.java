...
public class InitAckCarReceiver extends BroadcastReceiver {
    public InitAckCarReceiver() {
    }
...
//        List<Item> items = itemDAO.getAll();
        //TODO: 讀取ID, Phone, LineID where Service = myID
...
//
//            // 設定提醒
//            Intent alarmIntent = new Intent(context, AckCarReceiver.class);
